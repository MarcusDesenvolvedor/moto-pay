...
let TransactionsController = class TransactionsController {
    ...
    async createTransaction(user, createTransactionDto) {
        const transaction = await this.transactionsService.createTransaction(user.userId, createTransactionDto);
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], TransactionsController.prototype, "getUserCompanies", null);
