...
let RefreshTokenRepository = class RefreshTokenRepository {
    ...
    toDomain(prismaToken) {
        return new refresh_token_entity_1.RefreshToken(prismaToken.id, prismaToken.userId, prismaToken.token, prismaToken.expiresAt, prismaToken.revoked, prismaToken.createdAt);
    }
};
